 ...
 */
export type ConsumeAction = ConsumeAction1 & ConsumeAction2;
export type ConsumeAction1 = Action;
/**
...
export type ActionAccessSpecificationStreamId = string;
...
export interface ConsumeAction2 {
  /**
   * A set of requirements that a must be fulfilled in order to perform an Action. If more than one value is specied, fulfilling one set of requirements will allow the Action to be performed.
   */
  actionAccessibilityRequirement?: ActionAccessSpecificationStreamId | ActionAccessSpecificationStreamId[];
  /**
