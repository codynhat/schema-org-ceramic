 ...
 */
export type TaxiReservation = TaxiReservation1 & TaxiReservation2;
export type TaxiReservation1 = Reservation;
/**
...
export interface TaxiReservation2 {
  /**
   ...
   */
  pickupLocation?: PlaceStreamId | PlaceStreamId[];
  /**
