 ...
 */
export type MusicAlbum = MusicAlbum1 & MusicAlbum2;
export type MusicAlbum1 = MusicPlaylist;
/**
...
export type MusicAlbumProductionTypeStreamId = string;
export type MusicReleaseStreamId = string;
...
export interface MusicAlbum2 {
  /**
   * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
   */
  albumProductionType?: MusicAlbumProductionTypeStreamId | MusicAlbumProductionTypeStreamId[];
  /**
   * A release of this album.
   */
  albumRelease?: MusicReleaseStreamId | MusicReleaseStreamId[];
  /**
   ...
   */
  byArtist?: MusicGroupStreamId | PersonStreamId;
  [k: string]: unknown;
}
