 ...
 */
export type APIReference = APIReference1 & APIReference2;
export type APIReference1 = TechArticle;
/**
...
export interface APIReference2 {
  /**
   ...
   * Library file name e.g., mscorlib.dll, system.web.dll.
   */
  executableLibraryName?: string | string[];
  /**
   * Indicates whether API is managed or unmanaged.
   */
  programmingModel?: string | string[];
  /**
