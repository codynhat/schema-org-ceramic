 ...
 */
export type MobileApplication = MobileApplication1 & MobileApplication2;
export type MobileApplication1 = SoftwareApplication;
/**
...
export interface MobileApplication2 {
  /**
