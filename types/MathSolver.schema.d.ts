 ...
 */
export type MathSolver = MathSolver1 & MathSolver2;
export type MathSolver1 = CreativeWork;
/**
...
export type SolveMathActionStreamId = string;
...
export interface MathSolver2 {
  /**
   * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
   */
  mathExpression?: string | (string | SolveMathActionStreamId)[];
  [k: string]: unknown;
}
