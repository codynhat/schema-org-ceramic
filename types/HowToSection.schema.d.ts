 ...
 */
export type HowToSection = HowToSection1 & HowToSection2;
export type HowToSection1 = CreativeWork & ItemList & ListItem;
/**
 ...
 */
export type ItemList = Intangible;
/**
 ...
 */
export type ListItem = Intangible1;
/**
 * A utility class that serves as the umbrella for a number of 'intangible' things such as quantities, structured values, etc.
 */
export type Intangible1 = Thing1;
...
export interface HowToSection2 {
  /**
