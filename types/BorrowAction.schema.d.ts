 ...
 */
export type BorrowAction = BorrowAction1 & BorrowAction2;
export type BorrowAction1 = TransferAction;
/**
...
export interface BorrowAction2 {
  /**
   * A sub property of participant. The person that lends the object being borrowed.
   */
  lender?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  [k: string]: unknown;
}
