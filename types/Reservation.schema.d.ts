 ...
 */
export type Reservation = Reservation1 & Reservation2;
export type Reservation1 = Intangible;
/**
...
export type TicketStreamId = string;
...
export interface Reservation2 {
   ...
   */
  bookingAgent?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   ...
   */
  programMembershipUsed?: ProgramMembershipStreamId | ProgramMembershipStreamId[];
  /**
   ...
   */
  reservedTicket?: TicketStreamId | TicketStreamId[];
  /**
