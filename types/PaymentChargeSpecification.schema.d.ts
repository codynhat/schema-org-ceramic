 ...
 */
export type PaymentChargeSpecification = PaymentChargeSpecification1 & PaymentChargeSpecification2;
export type PaymentChargeSpecification1 = PriceSpecification;
/**
...
export interface PaymentChargeSpecification2 {
  /**
