 ...
 */
export type UpdateAction = UpdateAction1 & UpdateAction2;
export type UpdateAction1 = Action;
/**
...
export interface UpdateAction2 {
  /**
   * A sub property of object. The collection target of the action.
   */
  collection?: ThingStreamId | ThingStreamId[];
  /**
   * A sub property of object. The collection target of the action.
   */
  targetCollection?: ThingStreamId | ThingStreamId[];
  [k: string]: unknown;
}
