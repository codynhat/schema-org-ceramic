 ...
 */
export type Patient = Patient1 & Patient2;
export type Patient1 = MedicalAudience & Person;
/**
 * Target audiences for medical web pages.
 */
export type MedicalAudience = Audience & PeopleAudience;
/**
 ...
 */
export type PeopleAudience = Audience1;
/**
 * Intended audience for an item, i.e. the group for whom the item was created.
 */
export type Audience1 = Intangible;
/**
 * A person (alive, dead, undead, or fictional).
 */
export type Person = Thing1;
...
export interface Patient2 {
   ...
   */
  diagnosis?: MedicalConditionStreamId | MedicalConditionStreamId[];
  /**
