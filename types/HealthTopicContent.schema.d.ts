 ...
 *
 */
export type HealthTopicContent = HealthTopicContent1 & HealthTopicContent2;
export type HealthTopicContent1 = WebContent;
/**
...
export type HealthAspectEnumerationStreamId = string;
...
export interface HealthTopicContent2 {
  /**
   ...
   */
  hasHealthAspect?: HealthAspectEnumerationStreamId | HealthAspectEnumerationStreamId[];
  [k: string]: unknown;
}
