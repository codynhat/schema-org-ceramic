 ...
 *   (See examples below).
 */
export type TouristDestination = TouristDestination1 & TouristDestination2;
export type TouristDestination1 = Place;
/**
...
export type TouristAttractionStreamId = string;
...
export interface TouristDestination2 {
  /**
   * Attraction located at destination.
   */
  includesAttraction?: TouristAttractionStreamId | TouristAttractionStreamId[];
  /**
   * Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc.
   */
  touristType?: string | (string | AudienceStreamId)[];
  [k: string]: unknown;
}
