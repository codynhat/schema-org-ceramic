 ...
 */
export type DeliveryChargeSpecification = DeliveryChargeSpecification1 & DeliveryChargeSpecification2;
export type DeliveryChargeSpecification1 = PriceSpecification;
/**
...
export interface DeliveryChargeSpecification2 {
  /**
