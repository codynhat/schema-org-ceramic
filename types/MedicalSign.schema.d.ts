 ...
 */
export type MedicalSign = MedicalSign1 & MedicalSign2;
export type MedicalSign1 = MedicalSignOrSymptom;
/**
 * Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective.
 */
export type MedicalSignOrSymptom = MedicalCondition;
/**
...
export type PhysicalExamStreamId = string;
...
export interface MedicalSign2 {
  /**
   * A physical examination that can identify this sign.
   */
  identifyingExam?: PhysicalExamStreamId | PhysicalExamStreamId[];
  /**
   * A diagnostic test that can identify this sign.
   */
  identifyingTest?: MedicalTestStreamId | MedicalTestStreamId[];
  [k: string]: unknown;
}
