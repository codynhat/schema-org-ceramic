 ...
 */
export type ReviewAction = ReviewAction1 & ReviewAction2;
export type ReviewAction1 = AssessAction;
/**
...
export interface ReviewAction2 {
  /**
   * A sub property of result. The review that resulted in the performing of the action.
   */
  resultReview?: ReviewStreamId | ReviewStreamId[];
  [k: string]: unknown;
}
