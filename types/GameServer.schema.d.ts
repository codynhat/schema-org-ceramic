 ...
 */
export type GameServer = GameServer1 & GameServer2;
export type GameServer1 = Intangible;
/**
...
export type VideoGameStreamId = string;
export type GameServerStatusStreamId = string;
...
export interface GameServer2 {
   ...
   */
  game?: VideoGameStreamId | VideoGameStreamId[];
  /**
   * Number of players on the server.
   */
  playersOnline?: number | number[];
  /**
   * Status of a game server.
   */
  serverStatus?: GameServerStatusStreamId | GameServerStatusStreamId[];
  [k: string]: unknown;
}
