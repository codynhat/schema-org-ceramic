 ...
 */
export type PerformAction = PerformAction1 & PerformAction2;
export type PerformAction1 = PlayAction;
/**
...
export type EntertainmentBusinessStreamId = string;
...
export interface PerformAction2 {
  /**
   * A sub property of location. The entertainment business where the action occurred.
   */
  entertainmentBusiness?: EntertainmentBusinessStreamId | EntertainmentBusinessStreamId[];
  [k: string]: unknown;
}
