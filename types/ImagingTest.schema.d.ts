 ...
 */
export type ImagingTest = ImagingTest1 & ImagingTest2;
export type ImagingTest1 = MedicalTest;
/**
 * Any medical test, typically performed for diagnostic purposes.
 */
export type MedicalTest = MedicalEntity;
/**
...
export type MedicalImagingTechniqueStreamId = string;
...
export interface ImagingTest2 {
  /**
   * Imaging technique used.
   */
  imagingTechnique?: MedicalImagingTechniqueStreamId | MedicalImagingTechniqueStreamId[];
  [k: string]: unknown;
}
