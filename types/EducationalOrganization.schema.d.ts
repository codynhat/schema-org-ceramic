 ...
 */
export type EducationalOrganization = EducationalOrganization1 & EducationalOrganization2;
export type EducationalOrganization1 = CivicStructure & Organization;
/**
...
export interface EducationalOrganization2 {
  /**
