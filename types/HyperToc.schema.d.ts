 ...
 */
export type HyperToc = HyperToc1 & HyperToc2;
export type HyperToc1 = CreativeWork;
/**
...
export interface HyperToc2 {
   ...
   */
  tocEntry?: HyperTocEntryStreamId | HyperTocEntryStreamId[];
  [k: string]: unknown;
}
