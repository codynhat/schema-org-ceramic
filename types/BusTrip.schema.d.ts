 ...
 */
export type BusTrip = BusTrip1 & BusTrip2;
export type BusTrip1 = Trip;
/**
 * A trip or journey. An itinerary of visits to one or more places.
 */
export type Trip = Intangible;
/**
...
export type BusStationStreamId = string;
export type BusStopStreamId = string;
...
export interface BusTrip2 {
  /**
   * The stop or station from which the bus arrives.
   */
  arrivalBusStop?: BusStationStreamId | BusStopStreamId;
  /**
   ...
   */
  departureBusStop?: BusStationStreamId | BusStopStreamId;
  [k: string]: unknown;
}
