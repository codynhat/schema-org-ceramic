 ...
 */
export type CommunicateAction = CommunicateAction1 & CommunicateAction2;
export type CommunicateAction1 = InteractAction;
/**
...
export interface CommunicateAction2 {
  /**
   ...
   */
  language?: LanguageStreamId | LanguageStreamId[];
  /**
