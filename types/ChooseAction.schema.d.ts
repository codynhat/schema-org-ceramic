 ...
 */
export type ChooseAction = ChooseAction1 & ChooseAction2;
export type ChooseAction1 = AssessAction;
/**
...
export interface ChooseAction2 {
  /**
   * A sub property of object. The options subject to this action.
   */
  actionOption?: string | (string | ThingStreamId)[];
  /**
   * A sub property of object. The options subject to this action.
   */
  option?: string | (string | ThingStreamId)[];
  [k: string]: unknown;
}
