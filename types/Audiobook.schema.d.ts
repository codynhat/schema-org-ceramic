 ...
 * An audiobook.
 */
export type Audiobook = Audiobook1 & Audiobook2;
export type Audiobook1 = AudioObject & Book;
/**
 * An audio file.
 */
 ...
 * A book.
 */
export type Book = CreativeWork1;
/**
 * The most generic kind of creative work, including books, movies, photographs, software programs, etc.
 */
...
export interface Audiobook2 {
   ...
   */
  readBy?: PersonStreamId | PersonStreamId[];
  [k: string]: unknown;
}
