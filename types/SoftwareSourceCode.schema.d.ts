 ...
 */
export type SoftwareSourceCode = SoftwareSourceCode1 & SoftwareSourceCode2;
export type SoftwareSourceCode1 = CreativeWork;
/**
...
export type ComputerLanguageStreamId = string;
...
export interface SoftwareSourceCode2 {
  /**
   ...
   */
  codeSampleType?: string | string[];
  /**
   * The computer programming language.
   */
  programmingLanguage?: string | (string | ComputerLanguageStreamId)[];
  /**
   ...
   */
  targetProduct?: SoftwareApplicationStreamId | SoftwareApplicationStreamId[];
  [k: string]: unknown;
}
