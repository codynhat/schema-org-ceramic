 ...
 */
export type MedicalOrganization = MedicalOrganization1 & MedicalOrganization2;
export type MedicalOrganization1 = Organization;
/**
...
export interface MedicalOrganization2 {
  /**
   * Name or unique ID of network. (Networks are often reused across different insurance plans).
   */
  healthPlanNetworkId?: string | string[];
  /**
