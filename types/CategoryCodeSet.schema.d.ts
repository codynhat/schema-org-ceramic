 ...
 */
export type CategoryCodeSet = CategoryCodeSet1 & CategoryCodeSet2;
export type CategoryCodeSet1 = DefinedTermSet;
/**
 * A set of defined terms for example a set of categories or a classification scheme, a glossary, dictionary or enumeration.
 */
export type DefinedTermSet = CreativeWork;
/**
...
export interface CategoryCodeSet2 {
  /**
   * A Category code contained in this code set.
   */
  hasCategoryCode?: CategoryCodeStreamId | CategoryCodeStreamId[];
  [k: string]: unknown;
}
