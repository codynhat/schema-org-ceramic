 ...
 */
export type DatedMoneySpecification = DatedMoneySpecification1 & DatedMoneySpecification2;
export type DatedMoneySpecification1 = StructuredValue;
/**
...
export interface DatedMoneySpecification2 {
  /**
   * The amount of money.
   */
