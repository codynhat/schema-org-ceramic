 ...
 */
export type VoteAction = VoteAction1 & VoteAction2;
export type VoteAction1 = ChooseAction;
/**
 * The act of expressing a preference from a set of options or a large or unbounded set of choices/options.
 */
export type ChooseAction = AssessAction;
/**
...
export interface VoteAction2 {
  /**
   * A sub property of object. The candidate subject of this action.
   */
  candidate?: PersonStreamId | PersonStreamId[];
  [k: string]: unknown;
}
