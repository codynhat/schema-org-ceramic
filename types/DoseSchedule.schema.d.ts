 ...
 */
export type DoseSchedule = DoseSchedule1 & DoseSchedule2;
export type DoseSchedule1 = MedicalIntangible;
/**
...
export interface DoseSchedule2 {
  /**
   ...
   */
  doseValue?: number | QualitativeValueStreamId;
  /**
