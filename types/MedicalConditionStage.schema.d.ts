 ...
 */
export type MedicalConditionStage = MedicalConditionStage1 & MedicalConditionStage2;
export type MedicalConditionStage1 = MedicalIntangible;
/**
...
export interface MedicalConditionStage2 {
  /**
