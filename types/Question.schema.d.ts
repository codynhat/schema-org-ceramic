 ...
 */
export type Question = Question1 & Question2;
export type Question1 = Comment;
/**
...
export type AnswerStreamId = string;
...
export interface Question2 {
   ...
   */
  acceptedAnswer?: AnswerStreamId | ItemListStreamId;
  /**
   ...
   */
  suggestedAnswer?: (AnswerStreamId | ItemListStreamId) | (AnswerStreamId | ItemListStreamId)[];
  [k: string]: unknown;
}
