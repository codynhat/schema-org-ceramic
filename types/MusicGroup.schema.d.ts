 ...
 */
export type MusicGroup = MusicGroup1 & MusicGroup2;
export type MusicGroup1 = PerformingGroup;
/**
...
export type MusicAlbumStreamId = string;
...
export interface MusicGroup2 {
  /**
   * A music album.
   */
  album?: MusicAlbumStreamId | MusicAlbumStreamId[];
  /**
   * A collection of music albums.
   */
  albums?: MusicAlbumStreamId | MusicAlbumStreamId[];
  /**
   ...
   */
  musicGroupMember?: PersonStreamId | PersonStreamId[];
  /**
   * A music recording (track)—usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
   */
  track?: (ItemListStreamId | MusicRecordingStreamId) | (ItemListStreamId | MusicRecordingStreamId)[];
  /**
   * A music recording (track)—usually a single song.
   */
  tracks?: MusicRecordingStreamId | MusicRecordingStreamId[];
  [k: string]: unknown;
}
