 ...
 */
export type SportsEvent = SportsEvent1 & SportsEvent2;
export type SportsEvent1 = Event;
/**
...
export interface SportsEvent2 {
  /**
   * The away team in a sports event.
   */
  awayTeam?: PersonStreamId | SportsTeamStreamId;
  /**
   * A competitor in a sports event.
   */
  competitor?: (PersonStreamId | SportsTeamStreamId) | (PersonStreamId | SportsTeamStreamId)[];
  /**
   * The home team in a sports event.
   */
  homeTeam?: PersonStreamId | SportsTeamStreamId;
  /**
   * A type of sport (e.g. Baseball).
   */
  sport?: string | (string | string)[];
  [k: string]: unknown;
}
