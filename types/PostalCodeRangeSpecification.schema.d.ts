 ...
 */
export type PostalCodeRangeSpecification = PostalCodeRangeSpecification1 & PostalCodeRangeSpecification2;
export type PostalCodeRangeSpecification1 = StructuredValue;
/**
...
export interface PostalCodeRangeSpecification2 {
  /**
