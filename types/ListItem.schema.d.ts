 ...
 */
export type ListItem = ListItem1 & ListItem2;
export type ListItem1 = Intangible;
/**
...
export interface ListItem2 {
   ...
   */
  item?: ThingStreamId | ThingStreamId[];
  /**
   * A link to the ListItem that follows the current one.
   */
  nextItem?: ListItemStreamId | ListItemStreamId[];
  /**
   ...
   */
  previousItem?: ListItemStreamId | ListItemStreamId[];
  [k: string]: unknown;
}
