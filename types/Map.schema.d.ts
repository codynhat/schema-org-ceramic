 ...
 * A map.
 */
export type Map = Map1 & Map2;
export type Map1 = CreativeWork;
/**
...
export type MapCategoryTypeStreamId = string;
...
export interface Map2 {
   ...
   */
  mapType?: MapCategoryTypeStreamId | MapCategoryTypeStreamId[];
  [k: string]: unknown;
}
