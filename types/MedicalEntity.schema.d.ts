 ...
 */
export type MedicalEntity = MedicalEntity1 & MedicalEntity2;
export type MedicalEntity1 = Thing;
...
export type MedicalCodeStreamId = string;
export type MedicalGuidelineStreamId = string;
...
export type MedicalStudyStreamId = string;
...
export interface MedicalEntity2 {
  /**
   * A medical code for the entity, taken from a controlled vocabulary or ontology such as ICD-9, DiseasesDB, MeSH, SNOMED-CT, RxNorm, etc.
   */
  code?: MedicalCodeStreamId | MedicalCodeStreamId[];
  /**
   * A medical guideline related to this entity.
   */
  guideline?: MedicalGuidelineStreamId | MedicalGuidelineStreamId[];
  /**
   ...
   */
  recognizingAuthority?: OrganizationStreamId | OrganizationStreamId[];
  /**
   * If applicable, a medical specialty in which this entity is relevant.
   */
  relevantSpecialty?: MedicalSpecialtyStreamId | MedicalSpecialtyStreamId[];
  /**
   * A medical study or trial related to this entity.
   */
  study?: MedicalStudyStreamId | MedicalStudyStreamId[];
  [k: string]: unknown;
}
