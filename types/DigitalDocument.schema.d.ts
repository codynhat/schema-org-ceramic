 ...
 */
export type DigitalDocument = DigitalDocument1 & DigitalDocument2;
export type DigitalDocument1 = CreativeWork;
/**
...
export type DigitalDocumentPermissionStreamId = string;
...
export interface DigitalDocument2 {
  /**
   * A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to "public".
   */
  hasDigitalDocumentPermission?: DigitalDocumentPermissionStreamId | DigitalDocumentPermissionStreamId[];
  [k: string]: unknown;
}
