 ...
 */
export type MoneyTransfer = MoneyTransfer1 & MoneyTransfer2;
export type MoneyTransfer1 = TransferAction;
/**
...
export type BankOrCreditUnionStreamId = string;
...
export interface MoneyTransfer2 {
  /**
   * The amount of money.
   */
   ...
   */
  beneficiaryBank?: string | (string | BankOrCreditUnionStreamId)[];
  [k: string]: unknown;
}
