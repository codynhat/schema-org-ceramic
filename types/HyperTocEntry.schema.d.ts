 ...
 */
export type HyperTocEntry = HyperTocEntry1 & HyperTocEntry2;
export type HyperTocEntry1 = CreativeWork;
/**
...
export interface HyperTocEntry2 {
  /**
   ...
   */
  tocContinuation?: HyperTocEntryStreamId | HyperTocEntryStreamId[];
  /**
