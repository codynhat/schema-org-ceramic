 ...
 */
export type PublicationIssue = PublicationIssue1 & PublicationIssue2;
export type PublicationIssue1 = CreativeWork;
/**
...
export interface PublicationIssue2 {
  /**
   * Identifies the issue of publication; for example, "iii" or "2".
   */
  issueNumber?: (number | string) | (number | string)[];
  /**
