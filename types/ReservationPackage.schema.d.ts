 ...
 */
export type ReservationPackage = ReservationPackage1 & ReservationPackage2;
export type ReservationPackage1 = Reservation;
/**
...
export interface ReservationPackage2 {
  /**
   * The individual reservations included in the package. Typically a repeated property.
   */
  subReservation?: string;
  [k: string]: unknown;
}
