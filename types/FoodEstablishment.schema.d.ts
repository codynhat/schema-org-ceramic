 ...
 */
export type FoodEstablishment = FoodEstablishment1 & FoodEstablishment2;
export type FoodEstablishment1 = LocalBusiness;
/**
...
export type MenuStreamId = string;
...
export interface FoodEstablishment2 {
  /**
   * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
   */
  acceptsReservations?: boolean | string | ("Yes" | "No");
  /**
   * Either the actual menu as a structured representation, as text, or a URL of the menu.
   */
  hasMenu?: string | (string | string | MenuStreamId)[];
  /**
   * Either the actual menu as a structured representation, as text, or a URL of the menu.
   */
  menu?: string;
