 ...
 */
export type QuantitativeValueDistribution = QuantitativeValueDistribution1 & QuantitativeValueDistribution2;
export type QuantitativeValueDistribution1 = StructuredValue;
/**
...
export interface QuantitativeValueDistribution2 {
  /**
