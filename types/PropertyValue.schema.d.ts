 ...
 *
 */
export type PropertyValue = PropertyValue1 & PropertyValue2;
export type PropertyValue1 = StructuredValue;
/**
...
export interface PropertyValue2 {
  /**
   ...
   */
  propertyID?: string | (string | string)[];
  /**
