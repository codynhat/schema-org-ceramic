...
export type ScheduleStreamId = string;
...
export interface Event2 {
   ...
   */
  attendee?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   * A person attending the event.
   */
  attendees?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   ...
   *       or seasons.
   */
  eventSchedule?: ScheduleStreamId | ScheduleStreamId[];
  /**
   * An eventStatus of an event represents its status; particularly useful when an event is cancelled or rescheduled.
   */
  eventStatus?: EventStatusTypeStreamId | EventStatusTypeStreamId[];
  /**
   ...
   */
  organizer?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   * A performer at the event—for example, a presenter, musician, musical group or actor.
   */
  performer?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   * The main performer or performers of the event—for example, a presenter, musician, or actor.
   */
  performers?: OrganizationStreamId | PersonStreamId;
  /**
   ...
   */
  subEvent?: EventStreamId | EventStreamId[];
  /**
   * Events that are a part of this event. For example, a conference event includes many presentations, each subEvents of the conference.
   */
  subEvents?: EventStreamId | EventStreamId[];
  /**
   * An event that this event is a part of. For example, a collection of individual music performances might each have a music festival as their superEvent.
   */
  superEvent?: EventStreamId | EventStreamId[];
  /**
   ...
   */
  workFeatured?: CreativeWorkStreamId | CreativeWorkStreamId[];
  /**
   * A work performed in some event, for example a play performed in a TheaterEvent.
   */
  workPerformed?: CreativeWorkStreamId | CreativeWorkStreamId[];
  [k: string]: unknown;
}
