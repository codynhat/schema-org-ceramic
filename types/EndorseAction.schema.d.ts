 ...
 */
export type EndorseAction = EndorseAction1 & EndorseAction2;
export type EndorseAction1 = ReactAction;
/**
...
export interface EndorseAction2 {
  /**
   * A sub property of participant. The person/organization being supported.
   */
  endorsee?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  [k: string]: unknown;
}
