 ...
 */
export type DiagnosticLab = DiagnosticLab1 & DiagnosticLab2;
export type DiagnosticLab1 = MedicalOrganization;
/**
 * A medical organization (physical or not), such as hospital, institution or clinic.
 */
export type MedicalOrganization = Organization;
/**
...
export interface DiagnosticLab2 {
  /**
   * A diagnostic test or procedure offered by this lab.
   */
  availableTest?: MedicalTestStreamId | MedicalTestStreamId[];
  [k: string]: unknown;
}
