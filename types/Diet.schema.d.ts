 ...
 */
export type Diet = Diet1 & Diet2;
export type Diet1 = CreativeWork & LifestyleModification;
/**
...
export interface Diet2 {
   ...
   */
  endorsers?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   ...
   */
  physiologicalBenefits?: string | string[];
  /**
