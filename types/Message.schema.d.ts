 ...
 */
export type Message = Message1 & Message2;
export type Message1 = CreativeWork;
/**
...
export interface Message2 {
   ...
   */
  bccRecipient?:
    | (ContactPointStreamId | OrganizationStreamId | PersonStreamId)
    | (ContactPointStreamId | OrganizationStreamId | PersonStreamId)[];
  /**
   ...
   */
  messageAttachment?: CreativeWorkStreamId | CreativeWorkStreamId[];
  /**
   * A sub property of participant. The participant who is at the receiving end of the action.
   */
  recipient?:
    | (AudienceStreamId | ContactPointStreamId | OrganizationStreamId | PersonStreamId)
    | (AudienceStreamId | ContactPointStreamId | OrganizationStreamId | PersonStreamId)[];
  /**
