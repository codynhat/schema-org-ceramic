 ...
 */
export type MenuSection = MenuSection1 & MenuSection2;
export type MenuSection1 = CreativeWork;
/**
...
export type MenuSectionStreamId = string;
...
export interface MenuSection2 {
  /**
   * A food or drink item contained in a menu or menu section.
   */
  hasMenuItem?: MenuItemStreamId | MenuItemStreamId[];
  /**
   * A subgrouping of the menu (by dishes, course, serving time period, etc.).
   */
  hasMenuSection?: MenuSectionStreamId | MenuSectionStreamId[];
  [k: string]: unknown;
}
