 ...
 */
export type Taxon = Taxon1 & Taxon2;
export type Taxon1 = Thing;
...
export interface Taxon2 {
   ...
   */
  childTaxon?: string | (string | string | TaxonStreamId)[];
  /**
   * A Defined Term contained in this term set.
   */
  hasDefinedTerm?: DefinedTermStreamId | DefinedTermStreamId[];
  /**
   * Closest parent taxon of the taxon in question.
   */
  parentTaxon?: string | (string | string | TaxonStreamId)[];
  /**
