 ...
 */
export type MedicalWebPage = MedicalWebPage1 & MedicalWebPage2;
export type MedicalWebPage1 = WebPage;
/**
...
export type MedicalAudienceStreamId = string;
export type MedicalAudienceTypeStreamId = string;
...
export interface MedicalWebPage2 {
  /**
   ...
   */
  medicalAudience?:
    | (MedicalAudienceStreamId | MedicalAudienceTypeStreamId)
    | (MedicalAudienceStreamId | MedicalAudienceTypeStreamId)[];
  [k: string]: unknown;
}
