 ...
 * A doctor's office.
 */
export type Physician = Physician1 & Physician2;
export type Physician1 = MedicalBusiness & MedicalOrganization;
/**
...
export type HospitalStreamId = string;
...
export interface Physician2 {
   ...
   */
  hospitalAffiliation?: HospitalStreamId | HospitalStreamId[];
  /**
