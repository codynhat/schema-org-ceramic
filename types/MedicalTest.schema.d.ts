 ...
 */
export type MedicalTest = MedicalTest1 & MedicalTest2;
export type MedicalTest1 = MedicalEntity;
/**
...
export type MedicalSignStreamId = string;
export type MedicalConditionStreamId = string;
export type MedicalDeviceStreamId = string;
...
export interface MedicalTest2 {
  /**
   * Drugs that affect the test's results.
   */
  affectedBy?: DrugStreamId | DrugStreamId[];
  /**
   ...
   */
  signDetected?: MedicalSignStreamId | MedicalSignStreamId[];
  /**
   * A condition the test is used to diagnose.
   */
  usedToDiagnose?: MedicalConditionStreamId | MedicalConditionStreamId[];
  /**
   * Device used to perform the test.
   */
  usesDevice?: MedicalDeviceStreamId | MedicalDeviceStreamId[];
  [k: string]: unknown;
}
