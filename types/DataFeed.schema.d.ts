 ...
 */
export type DataFeed = DataFeed1 & DataFeed2;
export type DataFeed1 = Dataset;
/**
...
export type DataFeedItemStreamId = string;
...
export interface DataFeed2 {
  /**
   * An item within in a data feed. Data feeds may have many elements.
   */
  dataFeedElement?: (string | DataFeedItemStreamId | ThingStreamId) | (string | DataFeedItemStreamId | ThingStreamId)[];
  [k: string]: unknown;
}
