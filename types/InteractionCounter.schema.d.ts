 ...
 */
export type InteractionCounter = InteractionCounter1 & InteractionCounter2;
export type InteractionCounter1 = StructuredValue;
/**
...
export type WebSiteStreamId = string;
...
export interface InteractionCounter2 {
  /**
   ...
   */
  interactionService?: SoftwareApplicationStreamId | WebSiteStreamId;
  /**
