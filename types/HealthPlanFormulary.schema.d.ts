 ...
 */
export type HealthPlanFormulary = HealthPlanFormulary1 & HealthPlanFormulary2;
export type HealthPlanFormulary1 = Intangible;
/**
...
export interface HealthPlanFormulary2 {
  /**
