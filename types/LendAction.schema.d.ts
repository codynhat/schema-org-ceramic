 ...
 */
export type LendAction = LendAction1 & LendAction2;
export type LendAction1 = TransferAction;
/**
...
export interface LendAction2 {
  /**
   * A sub property of participant. The person that borrows the object being lent.
   */
  borrower?: PersonStreamId | PersonStreamId[];
  [k: string]: unknown;
}
