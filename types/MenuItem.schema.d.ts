 ...
 */
export type MenuItem = MenuItem1 & MenuItem2;
export type MenuItem1 = Intangible;
/**
...
export interface MenuItem2 {
   ...
   */
  menuAddOn?: (MenuItemStreamId | MenuSectionStreamId) | (MenuItemStreamId | MenuSectionStreamId)[];
  /**
