 ...
 */
export type RepaymentSpecification = RepaymentSpecification1 & RepaymentSpecification2;
export type RepaymentSpecification1 = StructuredValue;
/**
...
export interface RepaymentSpecification2 {
  /**
   * a type of payment made in cash during the onset of the purchase of an expensive good/service. The payment typically represents only a percentage of the full purchase price.
   */
  downPayment?: (number | MonetaryAmountStreamId) | (number | MonetaryAmountStreamId)[];
  /**
   * The amount to be paid as a penalty in the event of early payment of the loan.
   */
  earlyPrepaymentPenalty?: string;
  /**
