 ...
 */
export type FoodEstablishmentReservation = FoodEstablishmentReservation1 & FoodEstablishmentReservation2;
export type FoodEstablishmentReservation1 = Reservation;
/**
...
export interface FoodEstablishmentReservation2 {
  /**
   ...
   */
  partySize?: (number | QuantitativeValueStreamId) | (number | QuantitativeValueStreamId)[];
  /**
