 ...
 */
export type MedicalSignOrSymptom = MedicalSignOrSymptom1 & MedicalSignOrSymptom2;
export type MedicalSignOrSymptom1 = MedicalCondition;
/**
...
export interface MedicalSignOrSymptom2 {
  /**
