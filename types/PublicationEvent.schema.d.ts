 ...
 */
export type PublicationEvent = PublicationEvent1 & PublicationEvent2;
export type PublicationEvent1 = Event;
/**
...
export interface PublicationEvent2 {
  /**
   ...
   */
  publishedBy?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   * A broadcast service associated with the publication event.
   */
  publishedOn?: BroadcastServiceStreamId | BroadcastServiceStreamId[];
  [k: string]: unknown;
}
