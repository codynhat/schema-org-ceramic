 ...
 */
export type PublicationVolume = PublicationVolume1 & PublicationVolume2;
export type PublicationVolume1 = CreativeWork;
/**
...
export interface PublicationVolume2 {
  /**
   ...
   */
  volumeNumber?: (number | string) | (number | string)[];
  [k: string]: unknown;
}
