 ...
 */
export type RentAction = RentAction1 & RentAction2;
export type RentAction1 = TradeAction;
/**
 * The act of participating in an exchange of goods and services for monetary compensation. An agent trades an object, product or service with a participant in exchange for a one time or periodic payment.
 */
export type TradeAction = Action;
/**
...
export type RealEstateAgentStreamId = string;
...
export interface RentAction2 {
  /**
   * A sub property of participant. The owner of the real estate property.
   */
  landlord?: (OrganizationStreamId | PersonStreamId) | (OrganizationStreamId | PersonStreamId)[];
  /**
   * A sub property of participant. The real estate agent involved in the action.
   */
  realEstateAgent?: RealEstateAgentStreamId | RealEstateAgentStreamId[];
  [k: string]: unknown;
}
