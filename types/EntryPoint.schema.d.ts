 ...
 */
export type EntryPoint = EntryPoint1 & EntryPoint2;
export type EntryPoint1 = Intangible;
/**
...
export interface EntryPoint2 {
  /**
   * An application that can complete the request.
   */
  actionApplication?: SoftwareApplicationStreamId | SoftwareApplicationStreamId[];
  /**
   ...
   * An application that can complete the request.
   */
  application?: SoftwareApplicationStreamId | SoftwareApplicationStreamId[];
  /**
