 ...
 */
export type Nerve = Nerve1 & Nerve2;
export type Nerve1 = AnatomicalStructure;
/**
...
export interface Nerve2 {
   ...
   */
  sensoryUnit?: AnatomicalStructureStreamId | SuperficialAnatomyStreamId;
  /**
