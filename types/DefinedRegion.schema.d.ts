 ...
 *
 */
export type DefinedRegion = DefinedRegion1 & DefinedRegion2;
export type DefinedRegion1 = StructuredValue;
/**
...
export type PostalCodeRangeSpecificationStreamId = string;
...
export interface DefinedRegion2 {
  /**
   ...
   */
  postalCodeRange?: PostalCodeRangeSpecificationStreamId | PostalCodeRangeSpecificationStreamId[];
  [k: string]: unknown;
}
