 ...
 */
export type MedicalRiskEstimator = MedicalRiskEstimator1 & MedicalRiskEstimator2;
export type MedicalRiskEstimator1 = MedicalEntity;
/**
...
export interface MedicalRiskEstimator2 {
  /**
   ...
   */
  includedRiskFactor?: MedicalRiskFactorStreamId | MedicalRiskFactorStreamId[];
  [k: string]: unknown;
}
