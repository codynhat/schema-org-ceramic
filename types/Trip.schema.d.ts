 ...
 */
export type Trip = Trip1 & Trip2;
export type Trip1 = Intangible;
/**
...
export interface Trip2 {
   ...
   */
  itinerary?: (ItemListStreamId | PlaceStreamId) | (ItemListStreamId | PlaceStreamId)[];
  /**
   ...
   */
  partOfTrip?: TripStreamId | TripStreamId[];
  /**
   ...
   */
  subTrip?: TripStreamId | TripStreamId[];
  [k: string]: unknown;
}
