 ...
 */
export type SpeakableSpecification = SpeakableSpecification1 & SpeakableSpecification2;
export type SpeakableSpecification1 = Intangible;
/**
...
export interface SpeakableSpecification2 {
  /**
