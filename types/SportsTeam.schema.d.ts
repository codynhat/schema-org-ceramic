 ...
 */
export type SportsTeam = SportsTeam1 & SportsTeam2;
export type SportsTeam1 = SportsOrganization;
/**
...
export interface SportsTeam2 {
  /**
   * A person that acts as performing member of a sports team; a player as opposed to a coach.
   */
  athlete?: PersonStreamId | PersonStreamId[];
  /**
   * A person that acts in a coaching role for a sports team.
   */
  coach?: PersonStreamId | PersonStreamId[];
  /**
