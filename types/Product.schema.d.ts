...
export type EnergyConsumptionDetailsStreamId = string;
...
export interface Product2 {
   ...
   */
  hasEnergyConsumptionDetails?: EnergyConsumptionDetailsStreamId | EnergyConsumptionDetailsStreamId[];
  /**
   ...
   */
  isAccessoryOrSparePartFor?: ProductStreamId | ProductStreamId[];
  /**
   * A pointer to another product (or multiple products) for which this product is a consumable.
   */
  isConsumableFor?: ProductStreamId | ProductStreamId[];
  /**
