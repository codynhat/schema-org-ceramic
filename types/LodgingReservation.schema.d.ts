 ...
 */
export type LodgingReservation = LodgingReservation1 & LodgingReservation2;
export type LodgingReservation1 = Reservation;
/**
...
export interface LodgingReservation2 {
  /**
   ...
   */
  lodgingUnitDescription?: string | string[];
  /**
   * Textual description of the unit type (including suite vs. room, size of bed, etc.).
   */
  lodgingUnitType?: string | (string | QualitativeValueStreamId)[];
  /**
   * The number of adults staying in the unit.
   */
  numAdults?: number | QuantitativeValueStreamId;
  /**
   * The number of children staying in the unit.
   */
  numChildren?: number | QuantitativeValueStreamId;
  [k: string]: unknown;
}
