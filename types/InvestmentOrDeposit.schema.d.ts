 ...
 */
export type InvestmentOrDeposit = InvestmentOrDeposit1 & InvestmentOrDeposit2;
export type InvestmentOrDeposit1 = FinancialProduct;
/**
...
export interface InvestmentOrDeposit2 {
  /**
   * The amount of money.
   */
