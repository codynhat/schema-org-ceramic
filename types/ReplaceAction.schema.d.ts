 ...
 */
export type ReplaceAction = ReplaceAction1 & ReplaceAction2;
export type ReplaceAction1 = UpdateAction;
/**
...
export interface ReplaceAction2 {
  /**
   * A sub property of object. The object that is being replaced.
   */
  replacee?: ThingStreamId | ThingStreamId[];
  /**
   * A sub property of object. The object that replaces.
   */
  replacer?: ThingStreamId | ThingStreamId[];
  [k: string]: unknown;
}
