 ...
 */
export type HealthPlanCostSharingSpecification = HealthPlanCostSharingSpecification1 &
  HealthPlanCostSharingSpecification2;
export type HealthPlanCostSharingSpecification1 = Intangible;
/**
...
export interface HealthPlanCostSharingSpecification2 {
  /**
   * Whether the coinsurance applies before or after deductible, etc. TODO: Is this a closed set?
   */
  healthPlanCoinsuranceOption?: string | string[];
  /**
   * Whether The rate of coinsurance expressed as a number between 0.0 and 1.0.
   */
  healthPlanCoinsuranceRate?: number | number[];
  /**
   * Whether The copay amount.
   */
  healthPlanCopay?: PriceSpecificationStreamId | PriceSpecificationStreamId[];
  /**
   * Whether the copay is before or after deductible, etc. TODO: Is this a closed set?
   */
  healthPlanCopayOption?: string | string[];
  /**
